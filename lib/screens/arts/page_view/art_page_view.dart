...
class ArtPageView extends StatefulWidget {
  final List<Content> list;
  const ArtPageView({super.key, required this.list});

  @override
  State<ArtPageView> createState() => _ArtPageViewState();
}

class _ArtPageViewState extends State<ArtPageView> {
  @override
  Widget build(BuildContext context) {
    return Body(list: widget.list);
  }
}
